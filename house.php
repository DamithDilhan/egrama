        ...
        <div class="row mt-5">
            <div class="col-md-6 m-auto">
                <div class="card card-body text-center form">
                    ...
                    <?php require_once 'processHouse.php'; ?>
                    <?php 
                    if(isset($_GET['msg'])){    ?>
                    ...
                    <form action="processHouse.php" method="post">
                        ...
                        <div class="form-group">
                            <input type="text" name="hassesment_no" class="form-control" placeholder="House Assesment Number" required="required" maxlength="5">
                        </div>
