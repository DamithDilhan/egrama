        ...
        <div class="row mt-5">
            <div class="col-md-6 m-auto">
                <div class="card card-body text-center form">
                    ...
                    <?php require_once 'processShop.php'; ?>
                    <?php 
                    if(isset($_GET['msg'])){    ?>
                    ...
                    <form action="processShop.php" method="post">
                        ...
                        <input type="text" name="assesment_number" value="<?php echo $assesment_number ;?>" class="form-control" placeholder="Assesment Number" required="required" maxlength="10" hidden>

                        <div class="form-group">
                            <input type="text" name="reg_no" value="<?php echo $reg_no; ?>" class="form-control" placeholder="Registration Number" required="required" maxlength="5">
                        </div>
                        <div class="form-group">
                            <input type="text" name="name" value="<?php echo $name; ?>"class="form-control" placeholder="Name" required="required" maxlength="15">
                        </div>
