        ...
        <div class="row mt-5">
            <div class="col-md-6 m-auto">
                <div class="card card-body text-center form">
                    ...
                    <?php require_once 'processCrops.php'; ?>
                    <?php 
                    if(isset($_GET['msg'])){    ?>
                    ...
                    <form action="processCrops.php" method="post">
                        <h3 class="text-center">Cultivated Land</h3>
                        ...
                        <div class="form-group">
                            <input type="text" name="crops" class="form-control" placeholder="Crops" required="required" maxlength="20">
                        </div>
