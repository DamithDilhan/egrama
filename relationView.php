            ...
            <div class="col-md-6 m-auto">
                ...
                <h3 class="text-center">Relations</h3>
                    ...
                    <?php 
                            ...
                            {
                                header('location:relations.php?id=' .$id);
                                exit();
                            }
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="relations.php?edit=<?php echo $row['ID']; ?>&pid=<?php echo $row['PID']; ?>" class="btn btn-info">edit</a>
                                </td>
                                <td>
                                    <a href="processRelations.php?delete=<?php echo $row['ID']; ?>&pid=<?php echo $row['PID']; ?>" class="btn btn-danger">delete</a>
                                </td>
                            </tr>
                    ...
                    <div class="btn-group" role="group" aria-label="Basic example">
                        <a href="relations.php?add=<?php echo $id; ?>" class="btn btn-primary">Add</a>
