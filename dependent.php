        ...
        <div class="row mt-5">
            <div class="col-md-6 m-auto">
                <div class="card card-body text-center form">
                    ...
                    <?php require_once 'processDependent.php'; ?>
                    <?php 
                    if(isset($_GET['msg'])){    ?>
                    ...
                    <form action="processDependent.php" method="post">
                        ...
                        <div class="form-group">
                            <input type="text" name="name" class="form-control" placeholder="Name" required="required" maxlength="15">
                        </div>
